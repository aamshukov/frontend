...
void ir_visualization<Token, TreeTraits>::print_tree(const typename ir_visualization<Token, TreeTraits>::tree_type& tree, std::size_t level, std::wostream& stream)
{
    ...
    {
        print_tree(std::dynamic_pointer_cast<parser_tree<token_type, tree_traits_type>>(kid), level + 1, stream);
    }
...
template <typename Token, typename TreeTraits>
void ir_visualization<Token, TreeTraits>::print_trees(const typename ir_visualization<Token, TreeTraits>::trees_type& trees, std::wostream& stream)
{
    stream << std::endl;
...
template <typename Token, typename TreeTraits>
void ir_visualization<Token, TreeTraits>::collect_tree_dot_labels(const typename ir_visualization<Token, TreeTraits>::tree_type& root, std::wostream& stream)
{
    std::size_t k = 1;
...
template <typename Token, typename TreeTraits>
void ir_visualization<Token, TreeTraits>::build_tree_dot_graph(const typename ir_visualization<Token, TreeTraits>::tree_type& tree, std::wostream& stream)
{
    struct queue_entry
    {
        tree_type node;
    ...
    while(!queue.empty())
    {
        ...
        for(auto kid : (*entry.node).kids)
        {
            ...
            queue.emplace(queue_entry{ std::dynamic_pointer_cast<parser_tree<token_type, tree_traits_type>>(kid), k });
        }
    }
}

template <typename Token, typename TreeTraits>
void ir_visualization<Token, TreeTraits>::collect_dag_dot_labels(const typename ir_visualization<Token, TreeTraits>::dag_type& root, std::wostream& stream)
{
    ...
    while(!queue.empty())
    {
        ...
        {
            auto dag_kid(std::dynamic_pointer_cast<parser_dag<token_type, tree_traits_type>>(kid));
...
template <typename Token, typename TreeTraits>
void ir_visualization<Token, TreeTraits>::build_dag_dot_graph(const typename ir_visualization<Token, TreeTraits>::dag_type& dag, std::wostream& stream)
{
    std::queue<dag_type> queue;
    ...
    while(!queue.empty())
    {
        ...
        for(auto kid : (*node).kids)
        {
            ...
            queue.emplace(std::dynamic_pointer_cast<parser_dag<token_type, tree_traits_type>>(kid));
        }
    }
}

template <typename Token, typename TreeTraits>
void ir_visualization<Token, TreeTraits>::decorate_tree(const typename ir_visualization<Token, TreeTraits>::tree_type& tree, const string_type& dot_file_name, std::size_t k)
{
...
template <typename Token, typename TreeTraits>
void ir_visualization<Token, TreeTraits>::decorate_trees(const typename ir_visualization<Token, TreeTraits>::trees_type& trees, const string_type& dot_file_name)
{
...
template <typename Token, typename TreeTraits>
void ir_visualization<Token, TreeTraits>::decorate_dag(const typename ir_visualization<Token, TreeTraits>::dag_type& dag, const string_type& dot_file_name)
{
