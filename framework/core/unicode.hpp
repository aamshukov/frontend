...
ConversionResult ConvertUTF16toUTF32 (
                const UTF16** sourceStart, const UTF16* sourceEnd,
                UTF32** targetStart, UTF32* targetEnd, ConversionFlags flags,
                std::size_t& count, bool swap_bytes = false);
...
#define target_exhausted        targetExhausted
#define source_illegal          sourceIllegal
#define conversion_flags        ConversionFlags
#define strict_conversion       strictConversion
